...
module {
  func.func @main(%arg0: tensor<3619x12656xf32>, %arg1: tensor<12656x1xf32>, %arg2: tensor<3619x1xf32>) -> (tensor<3619x1xf32>, tensor<3619x1xf32>) {
    ...
    return %2, %3 : tensor<3619x1xf32>, tensor<3619x1xf32>
  }
}
