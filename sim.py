...
res_dual_9575f = sim(SystemSpec('specs/system_spec/WFIRST.yml'), ComputeSpec('specs/compute_spec/Dual-EPYC-9575F.yml'), Kernel=EFC, device=torch.device('cpu'), datatype='fp32')
